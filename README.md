...
`curl https://cdn.jsdelivr.net/gh/linyanglan/overwall_list/Overwall_Patch.sh|sh`

K2P(16M/32M通用)执行

`curl https://cdn.jsdelivr.net/gh/linyanglan/overwall_list/Overwall_Patch_MIPS.sh|sh`
...
将上述教程中的命令修改为`curl https://cdn.jsdelivr.net/gh/linyanglan/overwall_list/BackToStore.sh|sh`执行即可
